# table-loader/tests/test_loader_enhanced.py
import json
...
class TestTableLoaderEnhanced:
    """Enhanced tests for TableLoader edge cases"""
    ...
    def test_execute_load_stops_on_first_error(
    ...
    def test_get_exclude_fields_with_missing_report(self, mock_s3_client):
        ...
        # Mock S3 to raise FileNotFoundError
        error_response = {
            "Error": {
                "Code": "NoSuchKey",
                "Message": "The specified key does not exist.",
