...
!!! abstract "Field Mapping Configuration"
...
!!! abstract "Environment Variables"
    Configure environment variables for the REDCap Pipeline service.
...
!!! tip "Command Line Usage"
    Run the REDCap pipeline from the command line with various options.
...
!!! example "Programmatic Usage"
    Example of how to use the REDCap pipeline programmatically.
...
!!! tip "Docker Usage"
    Commands for building and running the REDCap Pipeline using Docker.
...
!!! abstract "2. Incremental Extraction"
    ```python
...
!!! abstract "4. Subject ID Resolution"
    ```python
...
!!! abstract "5. Fragment Generation"
    ```python
...
!!! abstract "API Client"
    The `REDCapClient` class handles interactions with the REDCap API.
...
!!! abstract "Error Handling"
    The pipeline implements robust error handling with custom exceptions and retry logic for REDCap API calls.
...
!!! abstract "Structured Logging"
    The pipeline utilizes structured logging for better observability.
...
!!! abstract "Metrics Collection"
    Key metrics are collected during pipeline execution.
...
!!! abstract "Health Checks"
    The pipeline includes health check functionality to verify dependencies.
...
!!! example "Unit Tests"
    Examples of unit tests for the REDCap pipeline components.
...
!!! example "Integration Tests"
    Examples of integration tests for the REDCap pipeline.
...
!!! failure "Common Issues"
    This section provides solutions for common issues encountered during pipeline execution.
