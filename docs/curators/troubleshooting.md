...
!!! failure "Subject ID Resolution Failed"
...
!!! failure "Invalid Data Type or Format"
...
!!! failure "Value Not in Allowed List (Enum Violation)"
...
!!! failure "Duplicate Record or Key"
